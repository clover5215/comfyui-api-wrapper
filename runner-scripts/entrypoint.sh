...
# Wait for ComfyUI to initialize (adjust sleep time as needed)
#echo "[INFO] Waiting for ComfyUI to initialize..."
#sleep 20

#echo "########################################"
#echo "[INFO] Starting index.py script..."
#echo "########################################"

# Run the index.py script
#cd /root
#python index.py

# Exit after index.py completes
#echo "[INFO] index.py completed, exiting container..."
#exit 0
